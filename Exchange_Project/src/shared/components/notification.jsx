...
function Notification() {
    ...
    return (
        <div className="notification_container">
            <button className='notTab' onClick={() => dispatch(authActions.setShowNotificationBox())}><i class="far fa-bell"></i></button>

            {authStates.showNotificationBox && <div className="not_Box">
